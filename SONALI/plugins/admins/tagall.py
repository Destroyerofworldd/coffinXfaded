...
TAGMES = [ " ** ʜᴇʏ ʙᴀʙʏ ᴋᴀʜᴀ ʜᴏ 🤗** ",
           ...
           " ** ᴍᴇʀᴇ sᴇ ᴅᴏsᴛɪ ᴋʀᴏɢᴇ..?? 🤔** ",
           " ** ᴇᴅʜᴀʀ ᴅᴇᴋʜᴏ ᴋʏᴀ ʜᴀɪ @ex4rcism ...😘** ",
           " ** ʙᴀʙᴜ ʏᴇ ᴅᴇᴋʜᴏ ғᴀᴅᴇᴅ ᴋᴀ ᴀᴅᴅᴀ @NexaMeetup... 😎** ",
           " ** sᴏɴᴇ ᴄʜᴀʟ ɢʏᴇ ᴋʏᴀ 🙄** ",
...
async def cancel_spam(client, message):
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("♦ᴄᴏғғɪɴ sᴛᴏᴘᴘᴇᴅ ᴛᴀɢɪɴɢ...♦")
